...
<ParamField path="effect" type="(arg: Arg, ctx: FnContext) => Effect<A, E>" required>
  The effectful function to execute
</ParamField>

<ParamField path="options.reactivityKeys" type="ReadonlyArray<Reactivity.Key>">
...
<ParamField path="f" type="(arg: Arg, ctx: FnContext) => A" required>
